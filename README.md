...
## Prometheus 
1. [Intro](./Notes/Prometheus.md)

## Kubernetes Certified Kubernetes Admin
### Downloaded Slides
[Course's PDF](./Notes/CKA_training/resources/)
### Core Infrastructures
1. [Logging](./Notes/CKA_training/Logs.md)
1. [ETCD](./Notes/CKA_training/ETCD.md)
